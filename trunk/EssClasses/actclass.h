...
//Класс классов действий - основной класс для манипулирования метаданными учетными действиями
...
class ACTClass : public Eidos
{
public:
	ACTClass(IBPP::Database MyDB);
	ACTClass(IBPP::Database MyDB, long ID_IN);
        ACTType* GetACTType(long ObjID);
        ACTType* AddACTType();
