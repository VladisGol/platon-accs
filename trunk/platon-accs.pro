######################################################################
# Automatically generated by qmake (2.01a) ?? ???. 2 21:02:47 2008
######################################################################
config += qt debug
...
TEMPLATE = app
TARGET = 
DEPENDPATH += . debug EssClasses EssForms EssWidgets images ibpp/core
INCLUDEPATH += . EssWidgets EssClasses ibpp/core EssForms
...
HEADERS += EssentialClass.h \
           ...
           ibpp/core/user.cpp
FORMS += mainwindow.ui EssForms/HypotesisEditForm.ui
SOURCES += main.cpp \
           mainWin.cpp \
